...
create table if not exists food_items(ID smallint unsigned not null auto_increment , name varchar(255) , category_ID smallint unsigned , description varchar(255),nutriscore varchar(255), shop varchar(255), brand varchar(255), url varchar(500) , primary key (ID  )) engine = innodb;
